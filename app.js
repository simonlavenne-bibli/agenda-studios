...
const API_URL = https://script.google.com/macros/s/https://script.google.com/macros/s/https://script.google.com/macros/s/AKfycbyouLRyvycutzzdjNtUuIlmOwZ3bqoNsQBlTiqn-FmKyPEa--vOlPecGIAdj-W1rRem/exec;
// ====== STATE ======
let state = {
    user: { name: '', email: '' },
    mySlots: [],
